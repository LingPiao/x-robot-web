...
<body style="TEXT-ALIGN: left;"><%String msnid = request.getParameter("msnid"); %>


<div id="Layer2">
  <table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#990000">
    <tr>
      <td align="left" valign="top" class="fs_no"><table width="270" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="162">&nbsp;</td>
            <td width="108">&nbsp;</td>
          </tr>
