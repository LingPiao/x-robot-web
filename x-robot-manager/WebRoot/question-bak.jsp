															...
															<table width="100%" border="0" cellpadding="3"
																...
																<tr>
																	...
																	<td colspan="5"  align="center" valign="middle" bgcolor="#FFFFFF"
																		...
																		<input type="button" name="button" value="查询" onclick="searchsubmit('search',pager);" />
																		<input type="button" name="button" value="排序" onclick="pxsubmit('paixu',pager);" />
																		<input type="button" name="button" value="整理" onclick="zlsubmit();" />
																	</td>
													...
													<td align="center" valign="top">
														<table width="100%" border="0" cellpadding="3"
															...
															<tr>
																...
																<td bgcolor="#FFFFFF" class="zl_huitxt"  align="left">
																	<select name="classes">
																		<option	value="1">3G业务</option>
																		<option	value="2">GSM业务</option>
																		<option	value="3">增值业务</option>
																		<option	value="4">数据业务</option>
																		<option	value="5">固定业务</option>
																		<option	value="6">国际业务</option>
																		<option	value="7">新国信业务</option>
																		<option	value="8">会员业务</option>
