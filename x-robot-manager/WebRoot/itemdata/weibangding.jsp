...
<%
	...
	while(rs1.next()){
		user_msn=rs1.getString("USER_MSN");
		user_msns+="'"+user_msn+"',";
	}
	user_msns+="'ssssssssss'";
	//query.setRecordSet("select * from unicom.t_contact contactemail not in("+user_msns+")");
	condition=" CONTACTEMAIL not in ("+user_msns+") order by CONTACTEMAIL ";
%>
													...
													<tr>
														<td align="center" valign="top">
															<table width="100%" border="0" cellpadding="3"
																...
																<%
																condition="1=1 and  CONTACTEMAIL not in ("+user_msns+") order by CONTACTEMAIL";
																query.setRecordSet(table,fieldarraystr,condition);
