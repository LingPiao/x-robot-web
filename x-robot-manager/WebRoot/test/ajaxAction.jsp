...
query.setRecordSet("select * from t_unicom_question where questionid="+questionid+"");
...
//System.out.println("ANSWER="+answer);
			sb.append("<question><content>"+answer+"</content></question>");
		}
	sb.append("</state>");	
}else if("search".equals(action)){
		query.setRecordSet("select * from t_unicom_question where QUESTION_CLASS='"+classid+"' and NORMALSTATE='3'");
		ResultSet rs = query.getResultSet();
		int i=0;
		while(rs.next()){
		if(i>=12)
