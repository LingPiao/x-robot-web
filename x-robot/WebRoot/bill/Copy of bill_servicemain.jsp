	...
	<tr>
		...
		<td background="../images/bill/bill_bg_03.png" width="338" height="33"><table width="100%">
          <tr>
            ...
            <td width="79%" class="STYLE1">用户服务查询</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table>			</td>
		<td rowspan="3">
	...
	function outputList(Itemroot){ 
		...
		for(var i=begin;i <end;i++){ 
			...
			OpenDate = Itemroot[i].getElementsByTagName("OpenDate");
				...
				innerStr +="       <tr>";
				innerStr +="             <td align=\"center\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">"+ServiceName[0].childNodes[0].nodeValue+"</td>";
				innerStr +="             <td align=\"center\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">"+OpenDate[0].childNodes[0].nodeValue+"</td>";
