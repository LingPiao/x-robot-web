...
<script type="text/javascript">
	...
	{
		form1.action="bill.action?op=service_detail&user_tel=<ww:property value="user_tel"/>";
		form1.submit();
	}
	</script>
	</head>
...
<tr>
  ...
  <tr>
    <td class="STYLE26">2.“历史账单”可以为您提供最近6个月的历史账单。</td>
  </tr>
  <tr>
    <td class="STYLE26">3.目前仅向世界风用户提供此查询服务；如意通和新势力用户暂不支持此项查询业务。</td>
  </tr>
        </table>
		</td>
