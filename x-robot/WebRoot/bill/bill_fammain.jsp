...
<tr>
	...
	<tr>
		...
		<td width="" height="28" colspan="3" align="center" background="../images/bill/icon_05.gif" class="fontStyle">亲友号码查询</td>
		<td>
	...
	<tr>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td width="79%" class="titleblue">亲友号码查询</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table></td>
          </tr>
...
<script type="text/javascript">
	...
	function startRequest(){ 
		...
		xmlHttp.open("POST", "domain_action.jsp?Bcode=100001000500001&AccCode=<ww:property value="user_tel"/>&Month=<ww:property value="month"/>&Password=", true); 
	...
	function outputList(Itemroot){ 
		...
		innerStr +="        <td width=\"25%\" align=\"center\" bgcolor=\"#179CBD\" class=\"STYLE13\"></td>";
		innerStr +="        <td width=\"25%\" align=\"center\" bgcolor=\"#F3F1F0\" class=\"STYLE14\"></td>";
		innerStr +="      </tr>";
		innerStr +="    </table></td>";
		innerStr +="  </tr>";
		innerStr +="<tr>";
		...
		innerStr +="<tr>";
		innerStr +="<td align=\"center\" bgcolor=\"#179CBD\" class=\"STYLE13\">设置时间</td>";
		innerStr +="<td align=\"center\" bgcolor=\"#179CBD\" class=\"STYLE13\">亲友号码</td>";
		innerStr +="<td align=\"center\" bgcolor=\"#179CBD\" class=\"STYLE13\">设置费用</td>";

		innerStr +="</tr>";
			for(var i=begin;i <end;i++){ 
				SetTime = Itemroot[i].getElementsByTagName("SetTime");
				Code = Itemroot[i].getElementsByTagName("Code");
				Costs = Itemroot[i].getElementsByTagName("Costs");
				if(SetTime[0].childNodes[0] !=null)
				{
					useSetTime = SetTime[0].childNodes[0].nodeValue;
				}
				if(Code[0].childNodes[0] !=null)
				{
					useCode = Code[0].childNodes[0].nodeValue;
				}
				...
				innerStr +="       <tr>";
				innerStr +="             <td align=\"center\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">"+useSetTime+"</td>";
				innerStr +="             <td align=\"center\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">"+useCode+"</td>";
  		...
  		innerStr +="  <td class=\"font12 STYLE4\" colspan=2>每页"+pagecount+"条,当前第"+pagenum+"页&nbsp;共"+realpage+"页";
   		innerStr +="  <a id=\"down\" href=\"bill.action?op=fam&pageno=1&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
   		innerStr +="  <img src=\"../images/bill/page_first.png\" width=\"42\" height=\"16\" border=0></a>";
   		innerStr +="  <a id=\"down\" href=\"bill.action?op=fam&pageno="+pre+"&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
   		innerStr +="  <img src=\"../images/bill/page_pre.png\" width=\"42\" height=\"16\" border=0></a>";
   		innerStr +="  <a id=\"down\" href=\"bill.action?op=fam&pageno="+next+"&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
   		innerStr +="  <img src=\"../images/bill/page_next.png\" width=\"42\" height=\"16\" border=0></a>";
   		innerStr +="  <a id=\"tail\" href=\"bill.action?op=fam&pageno="+realpage+"&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
