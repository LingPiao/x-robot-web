...
<script language="JavaScript">
	...
	{
		//alert(obj.value);
		window.location.href='game.action?op=weekresult&user_msn=<ww:property value="user_msn"/>&game_results=<ww:property value="game_results"/>&week='+obj.value
	}
</script>
<style type="text/css">
<!--
...
<span class="fontStyle">当前是[第<font color=red><b><ww:property value="currentWeek.WEEK"/></b></font>周]：<font color=red><b><ww:property value="currentWeek.STARTDATE"/>&nbsp;至&nbsp;<ww:property value="currentWeek.ENDDATE"/></b></font></span>
		</td>
          </tr>
          <tr>
            <td height="15" align="left" valign="middle">
            	<span class="fontStyle">您的最新排名：第<font color=red><b><ww:property value="['now_paiming']"/></b></font>名!</span><br/>
            	<span class="fontStyle">您本次游戏成绩：<font color=red><b><ww:property value="['game_results']"/></b></font></span>,<span class="fontStyle">本周最好成绩：<font color=red><b><ww:property value="['his_game_results']"/></b></font></span><br/>
	  ...
	  <tr>
 		<td height="15" align="left" valign="middle">
		    <span class="fontStyle">查看历史排名：</span>
			<select name="week" onchange="changeWeek(this);">
				<ww:iterator value="weeks" status="row">
				<option value="<ww:property value="['WEEKS']"/>" <ww:if test="['WEEKS']==week"> selected </ww:if>>第<ww:property value="['WEEKS']"/>周</option>
