          ...
          <tr>
			...
			<table width="363" height="209" background="../images/phone_success.gif" cellpadding="5">
              ...
              <tr>
			    <td height="20">&nbsp;</td>
                <td class="font15">&nbsp;</td>
                <td align="right" valign="top" class="font15"><input name="button" type="button" class="input_button3" id="button" value="确定" onclick="window.location.href='mms.action?op=mms&user_msn=<ww:property value="user_msn"/>'"></td>
				<td>&nbsp;</td>
              </tr>
			   <tr>
			    <td>&nbsp;</td>
