...
<tr>
                ...
                <td class="font15">
                  <input name="user_mobile" id="user_mobile" type="text" class="input_login1" readonly value=<ww:property value="user_mobile"/>>
                </td>
				<td>&nbsp;</td>
              </tr>
 <tr>
    ...
    <td>&nbsp;</td>
             <td>&nbsp;</td>
             <td align="right">
             <input name="button" type="button" class="input_button2" id="button" value="解除绑定" onClick="return validteCode();">&nbsp;
