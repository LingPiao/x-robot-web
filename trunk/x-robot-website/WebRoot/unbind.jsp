...
<script language="javascript">
	...
	function validteCode()
	{
		...
		bindform.action="bindmobile.action?op=unbindok";
		bindform.submit();
        ...
        <td align="center"><table width="50%" border="0" cellspacing="6" cellpadding="6">
          ...
          <tr>
            <td width="65%" align="left"> 　<input name="userid" id="userid" type="hidden" class="input_login1" value=<ww:property value="userid"/>>手机号码:
              <label>
              <input name="usermobile" id="usermobile" type="text" class="in"  readonly value=<ww:property value="usermobile"/>>
              </label></td>
          </tr>
          <tr>
            <td align="left">　　验证码:              
             ...
             &nbsp;<a href ="#" onClick="validteCode1();" class=a4>获取验证码</a></td>  
			</td>
          </tr>
          <tr>
            <td align="left">
          ...
          <tr>
            <td align="left" valign="top"><label>
                  <input name="button" type="button" class="buttonbg" id="button" value="解除" onClick="return validteCode();">
            </label></td>
          </tr>
         </form>	
          <tr>
