...
function movenemies() {
	...
	if (!available())	
	{
		window.alert("您的计算运行不正常(可能太慢),此次分数不参与统计");
...
<TABLE cellSpacing=0 cellPadding=0 align=left border=0><!-- row 1 -->
  ...
  <TR>
    ...
    <TD height=50 colspan="7" bgColor=#990000>
      ...
      <span class=ban>交费就到网上营业厅：</span><a href="http://www.10010.com" target=_blank>www.10010.com</a><font color=#990000>网上营<br>业</font>
