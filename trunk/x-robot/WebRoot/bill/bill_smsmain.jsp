...
<tr>
	...
	<tr>
		...
		<td width="" height="28" colspan="3" align="center" background="../images/bill/icon_05.gif" class="fontStyle">短信详单</td>
		<td>
	...
	<tr>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td width="79%" class="titleblue">短信详单</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table></td>
          </tr>
...
<script type="text/javascript">
	...
	function outputList(Itemroot){ 
		...
		for(var i=begin;i <end;i++){ 
			...
			{
				useCallTime = CallTime[0].childNodes[0].nodeValue.substring(0,9);
			}
