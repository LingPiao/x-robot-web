...
<script type="text/javascript">
	...
	{
		form1.action="bill.action?op=sp_detail&user_tel=<ww:property value="user_tel"/>";
		form1.submit();
	}
	</script>
	</head>
...
<tr>
	...
	<tr>
		...
		<td width="" height="28" colspan="3" align="center" background="../images/bill/icon_05.gif" class="fontStyle">增值业务查询</td>
		<td>
	...
	<tr>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td width="79%" class="titleblue">增值业务查询</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table></td>
          </tr>
