...
<tr>
	...
	<tr>
		...
		<td width="" height="28" colspan="3" align="center" background="../images/bill/icon_05.gif" class="fontStyle">实时余额</td>
		<td>
	...
	<tr>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td width="79%" class="titleblue">实时余额</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table></td>
          </tr>
...
<script type="text/javascript">
	...
	function startRequest(){ 
		...
		xmlHttp.open("POST", "domain_action.jsp?Bcode=100001000300001&AccCode=<ww:property value="user_tel"/>&Month=&Password=", true); 
	...
	function listInfo(){
		...
		if(flagitem == 0)
		{
			document.getElementById("personalinfo").innerHTML = Msgflag[0].childNodes[0].nodeValue;
		}
		else
		{	
			var Itemroot = xmlDoc.getElementsByTagName("ChargesInfo");  
			outputList(Itemroot);
		} 
	} 
	...
	function outputList(Itemroot){ 
		...
		Charges = Itemroot[0].getElementsByTagName("Charges");
		Balance = Itemroot[0].getElementsByTagName("Balance");
		if(Charges[0].childNodes[0] !=null)
		{
			useCharges = Charges[0].childNodes[0].nodeValue;
		}
		if(Balance[0].childNodes[0] !=null)
		{
			useBalance = Balance[0].childNodes[0].nodeValue;
		}	
		...
		innerStr +="	</tr>";
		innerStr +="	<tr>";
		innerStr +="	<td width=\"25%\" align=\"left\" bgcolor=\"#179CBD\" class=\"STYLE13\">实时话费：</td>";
		innerStr +="	<td width=\"25%\" align=\"left\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">"+useCharges+"</td>";
		innerStr +="	<td width=\"25%\" align=\"left\" bgcolor=\"#179CBD\" class=\"STYLE13\">余额：</td>";
		innerStr +="	<td width=\"25%\" align=\"left\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">"+useBalance+"</td>";
		innerStr +="	</tr>";
		innerStr +="	</table></td>";
		innerStr +="	</tr>";
		innerStr +="	<tr>";
