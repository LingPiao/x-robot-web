...
<script type="text/javascript">
	...
	{
		form1.action="bill.action?op=sms_detail&user_tel=<ww:property value="user_tel"/>";
		form1.submit();
	}
	</script>
	</head>
...
<tr>
	...
	<tr>
		...
		<td width="" height="28" colspan="3" align="center" background="../images/bill/icon_05.gif" class="fontStyle">短信详单查询</td>
		<td>
	...
	<tr>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td width="79%" class="titleblue">短信详单查询</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table></td>
          </tr>
