...
<tr>
	...
	<tr>
		...
		<td width="" height="28" colspan="3" align="center" background="../images/bill/icon_05.gif" class="fontStyle">用户服务查询</td>
		<td>
	...
	<tr>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td width="79%" class="titleblue">用户服务查询</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table></td>
          </tr>
	...
	<tr>
		...
		<td width="397" height="59" background="../images/main_14.jpg"><table width="95%">
          <tr>
            <td align="right"><input name="button" type="submit" class="input_button02" id="button" value="返回" onClick="window.location.href='bill.action?op=service&user_tel=<ww:property value="user_tel"/>';"></td>
          </tr>
        </table></td>
		<td>
...
<script type="text/javascript">
	...
	function startRequest(){ 
		...
		xmlHttp.open("POST", "domain_action.jsp?Bcode=100001000200002&AccCode=<ww:property value="user_tel"/>&Month=<ww:property value="month"/>&Password=", true); 
	...
	function outputList(Itemroot){ 
		...
		innerStr +="<tr>";
		innerStr +="<td align=\"center\" bgcolor=\"#179CBD\" class=\"STYLE13\">服务名称</td>";
		innerStr +="<td align=\"center\" bgcolor=\"#179CBD\" class=\"STYLE13\">开通日期</td>";
		innerStr +="</tr>";
		for(var i=begin;i <end;i++){ 
			ServiceName = Itemroot[i].getElementsByTagName("ServiceName");
			OpenDate = Itemroot[i].getElementsByTagName("OpenDate");
			openrealdate = OpenDate[0].childNodes[0].nodeValue;
			openrealdate1 = openrealdate.substring(0,4) + "-" + openrealdate.substring(4,6) + "-" + openrealdate.substring(6,8);
			
				innerStr +="       <tr>";
				innerStr +="             <td align=\"left\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">&nbsp;&nbsp;&nbsp;&nbsp;"+ServiceName[0].childNodes[0].nodeValue+"</td>";
				innerStr +="             <td align=\"center\" bgcolor=\"#F3F1F0\" class=\"STYLE14\">"+openrealdate1+"</td>";
  		...
  		innerStr +="  <td class=\"font12 STYLE4\" colspan=2 align=right>当前第"+pagenum+"页&nbsp;共"+realpage+"页";
   		innerStr +="  <a id=\"down\" href=\"bill.action?op=service_detail&pageno=1&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
   		innerStr +="  首  页</a>";
   		innerStr +="  <a id=\"down\" href=\"bill.action?op=service_detail&pageno="+pre+"&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
   		innerStr +="  上一页</a>";
   		innerStr +="  <a id=\"down\" href=\"bill.action?op=service_detail&pageno="+next+"&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
   		innerStr +="  下一页</a>";
   		innerStr +="  <a id=\"tail\" href=\"bill.action?op=service_detail&pageno="+realpage+"&month=<ww:property value="month"/>&user_tel=<ww:property value="user_tel"/>\">";
   		innerStr +="  最后一页</a></td>";
   		innerStr +="  </tr>";
   		innerStr +="  </table></td>";
		innerStr +="  </tr>	";
