...
<tr>
	...
	<tr>
		<td width="363" height="85" colspan="3" align="right" background="../images/bill/bill_bg_01_1.gif">&nbsp;</td>
	</tr>
	<tr>
		<td rowspan="3">
		...
		<td background="../images/bill/bill_bg_03.png" width="338" height="33"><table width="100%">
          <tr>
            ...
            <td width="79%" class="STYLE1">历史账单查询</td>
            <td width="5%">&nbsp;</td>
          </tr>
        </table>			</td>
		<td rowspan="3">
  ...
  <tr>
    <td><table width="100%">
      <tr>
        ...
        <td width="98%"><span class="STYLE14">请选择详单月份</span></td>
      </tr>
    </table></td>
  </tr>
