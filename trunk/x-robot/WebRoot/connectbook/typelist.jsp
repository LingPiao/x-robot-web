...
<table width="100%">
	<tr>
		<td width="40%" align="center"><input name="button" type="button" class="input_button6" id="button" value="全选/反选" OnClick="javascript:chkall('form1')"></td>
		<td width="30%" align="center"><input name="button" type="button" class="input_button3" id="button" value="添加" onClick="window.location.href='connectbook.action?ac=addtype&msnacc=<ww:property value="msnacc"/>';"></td>
		<td width="30%"><input name="button" type="button" class="input_button3" id="button" value="删除" OnClick="javasctipt:deltype()"></td>
	</tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#F3F1F0">
  <tr>	
    ...
    <td width="25%" height="22" colspan="3" align="center" background="images/book_bg.jpg" class="STYLE12">组名称</td>
	<td width="25%" height="22" colspan="3" align="center" background="images/book_bg.jpg" class="STYLE12">修改</td>
	<td width="25%" height="22" colspan="3" align="center" background="images/book_bg.jpg" class="STYLE10">查看联系人</td>
  </tr>
