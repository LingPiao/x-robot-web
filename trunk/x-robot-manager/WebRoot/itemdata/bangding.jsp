...
<%
	...
	query.setRecordSet("select * from unicom.msn_certification");
%>
								...
								<table width="100%" height="100%" border="0" cellpadding="0"
									...
									<tr>
										...
										<td width="79%" align="left" valign="top" id="listform">
											...
											<%
											table="unicom.msn_certification";
													...
													<tr>
														<td align="center" valign="top">
															<table width="100%" border="0" cellpadding="3"
																...
																<%
																condition="1=1 order by user_msn";
																query.setRecordSet(table,fieldarraystr,condition);
																ResultSet rs3 = query.getResultSet();
																int indexs=1;
																while(rs3.next()){
																	user_msn=rs3.getString("USER_MSN");
																	user_tel=rs3.getString("USER_TEL");
																	user_area=rs3.getString("USER_AREA");
																	user_date=rs3.getString("USER_DATE");
																	if(user_tel==null||"null".equals(user_tel)){
																	user_tel="";
																	}
																	if(user_area==null||"null".equals(user_area)){
																	user_area="";
																	}
																	if(user_date==null||"null".equals(user_date)){
																	user_date="";
																	}
																	i++;
