...
dataset.addSeries(timeseries1);
	...
	JFreeChart chart = ChartFactory.createTimeSeriesChart(data1+"至"+data2+"走势图","时间","值",xydataset,true,true,true);
	...
	categoryAxis.setDateFormatOverride(new SimpleDateFormat("MMdd")); 
