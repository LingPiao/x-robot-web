								...
								<table width="100%" height="100%" border="0" cellpadding="0"
									...
									<tr>
													...
													<tr>
														<td align="center" valign="top">
															<table width="100%" border="0" cellpadding="3"
																...
																<%
																condition="1=1 order by WELCOMEID";
																query.setRecordSet(table,fieldarraystr,condition);
																ResultSet rs3 = query.getResultSet();
																int indexs=1;
																while(rs3.next()){
																	id=rs3.getString("WELCOMEID");
																	complain=rs3.getString("CONTENT");
										...
										<td width="79%" align="left" valign="top" style="display:none" id="add">
											<form name =addform method=post action = "welcomedb.jsp" onSubmit=return(formCheck())>
