...
<%
	...
	query.setRecordSet("select * from T_FORBIDDENWORD");
%>
	   ...
	   function delmes(theForm)
	   {
	        ...
	        if (flag !=0){
	            if (confirm("删除将不能恢复，是否继续？"))  {
	                var url="filterdel.jsp?action=del";
	                theForm.action=url;
	                theForm.submit();
	            }
	        }
								...
								<table width="100%" height="100%" border="0" cellpadding="0"
									...
									<tr>
													...
													<tr>
														<td align="center" valign="top">
															<table width="100%" border="0" cellpadding="3"
																...
																<%
																condition="1=1 order by FORBIDDENID";
																query.setRecordSet(table,fieldarraystr,condition);
																ResultSet rs3 = query.getResultSet();
																int indexs=1;
																while(rs3.next()){
																	id=rs3.getString("FORBIDDENID");
																	complain=rs3.getString("FORBIDDEN");
																...
																<tr>
																	...
																	<td align="center" valign="middle" bgcolor="#FFFFFF">
																		<a href="#" onclick="javaScript:editmes(pager,<%=id %>,'<%=id %>','<%=complain %>');"><img src = "images/edit.gif" border = 0>
																		</a>	
																	</td>
																	<td align="center" valign="middle" bgcolor="#FFFFFF">
										...
										<td width="79%" align="left" valign="top" style="display:none" id="add">
											<form name =addform method=post action = "filterdb.jsp" onSubmit=return(formCheck())>
														...
														<table width="100%" border="0" cellpadding="3"
															...
															<tr>
																...
																<td bgcolor="#FFFFFF" class="zl_huitxt"  align="left">
																	<textarea name="mes_content" id="mes_content" cols="50" rows="6" onKeyDown="textCounter(this.form.mes_content,this.form.remLen,100);"   onKeyUp="textCounter(this.form.mes_content,this.form.remLen,100);"></textarea>
